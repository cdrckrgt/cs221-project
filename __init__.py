...
class FlappyBird(base.PyGameWrapper):
    ...
    def getGameState(self):
        ...
        state = {
            ...
            # should these be 0 or should they be random...
            "dummy_gate_dist": 0, # np.random.normal(mean, stddev)
            "dummy_gate_top": 0, # np.random.normal(mean, stddev)
            "dummy_gate_bot": 0, # np.random.normal(mean, stddev)
        }
